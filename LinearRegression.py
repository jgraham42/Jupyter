# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 13:42:35 2019
...
#imp = Imputer(strategy = 'mean', verbose = 1)
...
model = SelectFromModel(linregfit, prefit = True)
...
#logit_roc_auc = roc_auc_score(Y_test, linreg.predict(X_test))
#fpr, tpr, thresholds = roc_curve(Y_test, linreg.predict_proba(X_test)[:,1])
#plt.figure()
